...
import { LastValidatorPower } from "cosmjs-types/cosmos/staking/v1beta1/genesis";
import {
  Delegation,
  Params,
  Redelegation,
...
export const protobufPackage = "fx.staking.v1beta1";
...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.allowances) {
      Allowance.encode(v!, writer.uint32(74).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      allowances: Array.isArray(object?.allowances)
        ? object.allowances.map((e: any) => Allowance.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.allowances) {
      obj.allowances = message.allowances.map((e) => (e ? Allowance.toJSON(e) : undefined));
    } else {
      obj.allowances = [];
    }
    return obj;
...
function createBaseAllowance(): Allowance {
  return { validatorAddress: "", ownerAddress: "", spenderAddress: "", allowance: "" };
}

export const Allowance = {
  encode(message: Allowance, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.spenderAddress !== "") {
      writer.uint32(26).string(message.spenderAddress);
    }
    if (message.allowance !== "") {
      writer.uint32(34).string(message.allowance);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): Allowance {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Allowance {
    return {
      ...
      spenderAddress: isSet(object.spenderAddress) ? String(object.spenderAddress) : "",
      allowance: isSet(object.allowance) ? String(object.allowance) : "",
    };
  },
  ...
  toJSON(message: Allowance): unknown {
    ...
    message.spenderAddress !== undefined && (obj.spenderAddress = message.spenderAddress);
    message.allowance !== undefined && (obj.allowance = message.allowance);
    return obj;
  },

  create<I extends Exact<DeepPartial<Allowance>, I>>(base?: I): Allowance {
    return Allowance.fromPartial(base ?? {});
  },
